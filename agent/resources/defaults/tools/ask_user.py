...
@tool(
    "ask_user",
    description=(
        "Ask the user a question when their input is required in either Plan or Act mode. "
        "Prefer this tool over asking any user-facing question in prose. First use available "
        "context and tools to discover facts that can be determined directly. "
